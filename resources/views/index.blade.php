            ...
            <tr>
              ...
              <td class="p-0 text-right text-sm font-medium">
                <div class="flex justify-end">
                  ...
                  <div>
                    <a href="/tasks/{{ $item->id }}/edit/" class="inline-block text-center py-4 w-20 underline underline-offset-2 text-sky-600 md:hover:bg-sky-100 transition-colors">更新</a>
                  </div>
